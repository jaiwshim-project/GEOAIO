...
import { getBlogPosts, getBlogCategories, deleteBlogPost, type BlogPost, type BlogCategory } from '@/lib/supabase-storage';
...
export default function BlogPage() {
  ...
  const [categories, setCategories] = useState<BlogCategory[]>(DEFAULT_CATEGORIES);
  const [activeTab, setActiveTab] = useState(DEFAULT_CATEGORIES[0].slug);
