            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="relative bg-white rounded-xl border-2 border-indigo-300 p-5">
                  ...
                  <div className="absolute -top-2.5 right-4 px-2.5 py-0.5 bg-gradient-to-r from-indigo-600 to-purple-700 text-white text-[10px] font-bold rounded-full tracking-wider">
                    ENTERPRISE
                  </div>
                  <div className="mt-1 mb-3">
                    ...
                    <p className="text-[10px] text-gray-400 mt-0.5">부가세 별도</p>
                  </div>
                  <ul className="space-y-1.5 text-xs text-gray-700 border-t border-gray-100 pt-3">
