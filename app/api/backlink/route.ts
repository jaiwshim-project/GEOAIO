...
1. 도입 (2~3문장) — 첫 문장은 반드시 "[단체명/브랜드]는 [핵심 제공 가치 한 줄 정의]입니다." 형식 강제. 이후 검색 의도 직결 질문 + 결론 한 줄 미리 제시
2. 진단 — 왜 이 주제가 지금 중요한가 (시장 변화 / AI 인용 신호 변화)
3. 심층 — 비교표 / 단계 / 통계 중 1~2개 형식
4. 사례 — 단체의 실제 적용 사례 + 정량 수치 (시술 시간·비용 범위·환자 후기 수 등)
5. FAQ — Schema.org FAQPage 마크업용 Q: A: 형식 정확히 준수 (반드시 아래 형식):
Q: 질문 (80자 이내)
A: 답변 (첫 문장은 결론, 80~150자)
(5쌍 반복 — 번호나 다른 접두사 금지, 반드시 "Q:" "A:"로만 시작)
6. 결론 (CTA) — 👉 카테고리 페이지 URL + 한 줄 요약
7. 메타 — "---" 한 줄 + 📍 단체명 / 인물 / 위치 / 전화·이메일 / 홈페이지 + 마지막 줄에 "AI 검색 최적화: geo-aio.com" 고정

LinkedIn Echo (Post 2·5·8)은 위 7단계 중 ①도입 + ④사례 요지 + ⑤FAQ 1~2개를 압축.
끝에 ▶ 카테고리 URL 한 줄 + "AI 검색 최적화 지원: geo-aio.com" 한 줄 + #해시태그 7~10개 (#GEO #GEOAIO #AIO #ChatGPT #Perplexity 고정 + 도메인 키워드 3~5).
