...
이 단계에서는 구조보다 **내용의 풍부함**에 집중하세요.
E-E-A-T 구조화(FAQ, 비교표 등)는 별도 단계에서 처리됩니다.

### 작성 기준
- 분량: **최소 1,500자 이상** (한국어 기준)
- 제목: 숫자·성과 포함 ("95% 달성", "3배 향상" 등)
- 전문성: 업계 통계, 전문 용어 정의, 구체적 수치 포함
- RAG 자료가 있으면 해당 정보를 적극 활용
- 해시태그 10개 포함
