...
### 작성 기준
- 분량: **1,400~1,700자 한정** (한국어 기준). 1,800자 절대 초과 금지 — 토큰 한도에서 잘립니다.
  · 7단계 골격은 모두 포함하되 각 H2 본문은 2~3문단(150~250자)으로 콤팩트하게.
  · FAQ 답변은 각 80~150자, 결론은 200~300자.
  · 분량을 늘리려 욕심내지 말 것. 짧고 명확한 정의문이 AI 인용에 더 유리합니다.
