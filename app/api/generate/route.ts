...
### 작성 기준
- 분량: **반드시 1,500자 이상**, 1,800~2,000자 권장. 2,100자를 크게 넘지 않도록.
  · 4원칙(질문형 H2·반복 브랜드·케이스·외부 신호) 모두 담기에 1,800~2,000자가 자연스러움.
  · 7단계 골격을 모두 충분히 채워야 합니다 — 빈 콘텐츠 절대 금지.
  · 각 H2 섹션은 본문 2~3문단(180~250자) + 불릿 3개 이상 필수.
