...
### 작성 기준
- 분량: **1,200~1,500자 한정** (한국어 기준). 1,600자 절대 초과 금지 — 토큰 한도에서 잘립니다.
  · 7단계 골격은 모두 포함하되 본문을 매우 콤팩트하게 작성.
  · 각 H2 본문 100~180자 (2문단·짧은 불릿 3개 정도).
  · FAQ 답변 60~120자, 결론 150~250자, 비교표 3행 한정.
  · 분량을 늘리려 욕심내지 말 것. **짧고 명확한 정의문이 AI 인용에 더 유리**합니다.
  · 토큰 한도(8192) 안에 들어가야 응답이 잘리지 않습니다. 1500자 + 광고+해시태그가 약 6500토큰.
