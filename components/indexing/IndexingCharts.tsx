...
export function ReasonsPie({ reasons }: { reasons: Record<string, number> }) {
  ...
  if (data.length === 0) return (
    <div className="w-full bg-white rounded-xl border border-gray-200 p-4">
      <div className="flex items-center justify-center h-52 text-sm text-gray-400">미색인 사유 데이터 없음</div>
      {description}
    </div>
  );
  return (
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      ...
      <div className="col-span-full bg-white rounded-xl border border-gray-200 p-4">
        <h3 className="text-sm font-semibold text-gray-700 mb-2">📊 색인 현황 요약</h3>
