...
export default function BlogHeroCallout() {
  return (
    <div className="group relative mt-4 max-w-3xl cursor-pointer transition-transform duration-300 hover:-translate-y-0.5 hover:scale-[1.01] active:-translate-y-0 active:scale-[1.005]">
      ...
      <div className="absolute -inset-[3px] rounded-xl bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 blur-[6px] opacity-60 animate-pulse group-hover:opacity-95 group-hover:blur-[10px] group-active:opacity-95 transition-colors duration-300" />
      {/* 정적 골드 보더 그라디언트 */}
      <div className="absolute -inset-[1.5px] rounded-xl bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-500 opacity-90 group-hover:-inset-[2.5px] group-hover:from-amber-600 group-hover:via-yellow-500 group-hover:to-amber-600 transition-colors duration-300" />
      ...
      <div className="relative flex items-start gap-2 sm:gap-3 px-3 sm:px-4 py-3 sm:py-3.5 bg-gradient-to-br from-amber-100 via-yellow-50 to-orange-100 rounded-xl shadow-lg shadow-amber-200/60 ring-2 ring-white/60 group-hover:from-amber-200 group-hover:via-yellow-100 group-hover:to-orange-200 group-hover:shadow-xl group-hover:shadow-amber-300/70 group-hover:ring-amber-100 group-active:from-amber-200 group-active:via-yellow-100 group-active:to-orange-200 transition-colors duration-300">
        ...
        {/* 좌측 골드 액센트 바 */}
        <span className="absolute left-0 top-2 bottom-2 w-1 bg-gradient-to-b from-amber-500 via-yellow-500 to-amber-500 rounded-full group-hover:top-1 group-hover:bottom-1 group-hover:w-1.5 transition-colors duration-300" />
        {/* 배지 — 모바일에서 살짝 작게(6px) */}
        ...
        <p className="text-[12.5px] sm:text-[15px] font-bold text-slate-900 leading-snug pl-0.5 sm:pl-1 break-keep">
          본 블로그 사이트는{' '}
          <span className="inline-block px-1.5 py-0.5 rounded bg-amber-200/70 text-amber-900 font-extrabold transition-colors duration-300 group-hover:bg-amber-300 group-hover:scale-105 group-active:bg-amber-300 break-keep">구글 검색과 색인</span>
          ,{' '}
          <span className="inline-block px-1.5 py-0.5 rounded bg-violet-200/70 text-violet-900 font-extrabold transition-colors duration-300 group-hover:bg-violet-300 group-hover:scale-105 group-active:bg-violet-300 break-keep">AI 인용과 추천</span>
          에 최적화되어{' '}
          <span className="inline-block px-1.5 py-0.5 rounded bg-gradient-to-r from-amber-500 to-yellow-500 text-white font-extrabold shadow-sm transition-colors duration-300 group-hover:from-amber-600 group-hover:to-yellow-600 group-hover:shadow-md group-hover:shadow-amber-400/60 group-active:from-amber-600 group-active:to-yellow-600 break-keep">최대의 홍보와 마케팅 효과</span>
          를 제공합니다!
        </p>
      </div>
    </div>
